...
def battle(enemy, player):
    ...
    while enemy.isEnemyAlive() and player.isPlayerAlive():
        ...
        print('Attack(1) | Defend(2) | Rest(3) | Flee(4)')
        choice = input()
        clear_lines(3)
